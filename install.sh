...
echo "    /qf-1 <idea>  — Phase 1: Requirements discovery"
echo "    /qf-2             — Phase 2: Architecture design"
echo "    /qf-3            — Phase 3: Execution handoff"
echo "    /qf-4             — Phase 4: QA & verification"
echo "    /qf-c                  — Team pipeline orchestrator"
echo "    /qf-s                — Project status & session resume"
echo ""
echo "  Get started:"
echo "    cd $TARGET_DIR"
echo "    claude"
echo "    /qf-1 my feature idea"
echo ""
